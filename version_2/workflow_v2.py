...
@task 
def split_data(input_:pd.DataFrame, output_:pd.Series, test_size: float)-> Dict[str, Any]: 
    X_tr, X_te, y_tr, y_te = train_test_split(input_,output_,test_size=test_size,random_state=0)
...
def main(path: str):
    ...
    train_test_dict = split_data(input_=input_data, output_=target_data, test_size=TEST_DATA_RATIO)
